...
function toNumber(value, def) {
  if(typeof value === 'number' && value + 1 > value) {return value;} else if(typeof(parseInt(value)) === 'number' && parseInt(value) + 1 > parseInt(value)) {return parseInt(value);} else if(typeof def === 'number') {return def;}
}
